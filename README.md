...
This project is a Python-based penetration testing toolkit developed as part of an internship task. 
The toolkit demonstrates fundamental penetration testing concepts through a modular and ethical approach.
It is designed strictly for educational and learning purposes.
The toolkit includes multiple modules such as a port scanner and a brute-force simulation module.
Each module is implemented separately to maintain modularity and clarity.
The tool runs via a command-line interface and is intended to be used only on systems owned by the user or where explicit permission has been granted.
